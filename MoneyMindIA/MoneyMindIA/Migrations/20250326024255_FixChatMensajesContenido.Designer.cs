...
namespace MoneyMindIA.Migrations
{
    ...
    [Migration("20250326024255_FixChatMensajesContenido")]
    partial class FixChatMensajesContenido
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatMensaje", b =>
                {
            ...
            modelBuilder.Entity("ChatMensaje", b =>
                {
                    b.HasOne("MoneyMindIA.Models.Entidades.Recomendacion", "Recomendacion")
                        .WithMany("Mensajes")
            ...
            modelBuilder.Entity("MoneyMindIA.Models.Entidades.Transaccion", b =>
                {
                    ...
                    b.HasOne("MoneyMindIA.Models.Entidades.Tarjeta", "Tarjeta")
                        .WithMany()
